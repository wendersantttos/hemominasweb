"""
Django settings for gerenciador_lembretes project.
...
SECRET_KEY = 'django-insecure-jb66!60o81b(8#l02=z$%)7-bqbe8@f=5xpmt$jrjt+3xdx^-6'
...
WSGI_APPLICATION = 'gerenciador_lembretes.wsgi.application'
